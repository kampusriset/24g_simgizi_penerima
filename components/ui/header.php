<header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-10 shadow-sm">
    ...
    <div class="flex items-center gap-2 sm:gap-4">
        ...
        <button class="text-rose-500 hover:text-rose-700 hover:bg-rose-50 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors hidden sm:flex items-center gap-2">
